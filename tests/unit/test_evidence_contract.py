...
class EvidenceContractTests(unittest.TestCase):
    def test_feature_bug_and_refactor_need_distinct_observable_evidence(self) -> None:
        ...
        refactor = {**common(), "characterization": "golden outputs", "behavior_equivalent": True}
    ...
    def test_numerical_requires_units_shapes_reference_tolerance_and_convergence(self) -> None:
        evidence = {
            **common(),
            ...
            "convergence": {"observed_order": 2.01, "minimum_order": 1.9},
        }
    ...
    def test_performance_and_portability_guards_are_discriminating(self) -> None:
        ...
        portability = {
            **common(),
            "backends": {"serial": "pass", "openmp": "pass", "cuda-build": "pass"},
        }
